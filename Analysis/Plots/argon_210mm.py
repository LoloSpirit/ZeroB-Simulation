...
plot(files, max_time=3, interval=[1300, 3800], peak_settings=peak_settings, colors=['black'])
...
plot(files, transformation=transformation, peak_settings=peak_settings, interval=[1300, 3800], zoom_settings=zoom)